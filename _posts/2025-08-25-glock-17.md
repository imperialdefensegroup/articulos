...
> **¿Cómo subirlo?** Coloca este archivo en `/_posts/` con nombre `2025-08-25-glock-17.md` (o actualiza la fecha al día que publiques). Si usas un repositorio *solo* como artículo, también puedes renombrarlo como `README.md` en la carpeta del artículo.
